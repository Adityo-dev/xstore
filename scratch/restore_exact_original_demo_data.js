...
try {
  // Restore exact original public/data/products.json from git commit e34e21d
  ...
  console.log('Restored exact original public/data/products.json from git commit e34e21d');

  // Restore exact original src/data/products.js from git commit e34e21d
  ...
  console.log('Restored exact original src/data/products.js from git commit e34e21d');
} catch (err) {
  console.error('Error restoring original demo data:', err.message);
}
