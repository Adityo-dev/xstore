    ...
    reviews: [
      {
        user: "Tanvir Hasan",
        rating: 4.9,
        comment: "Extremely lightweight and pinpoint accurate sensor. Best mouse I have used!",
        date: "2026-02-14",
...
// Merge items (put new hardware items at the top so they appear first)
const combined = [...hardwareAndGameProducts, ...existingJson];

fs.writeFileSync(jsonPath, JSON.stringify(combined, null, 2), 'utf8');
console.log('Successfully updated public/data/products.json with', combined.length, 'total items.');
