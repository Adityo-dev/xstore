...
function SocialIconAndPayment() {
  return (
    <div className="container mx-auto border-t border-[#FFFFFF24] mt-4 pt-6 flex flex-col md:flex-row items-center justify-between">
      <div className="mt-4 flex justify-center space-x-5 text-xl text-white">
      ...
      <div className="flex space-x-4 items-center">
        {[
          ...
          <div
            key={logo?.id}
            className="w-16 h-10 bg-white flex items-center justify-center rounded-sm"
          >
            <Image
              src={logo?.src}
              alt={logo?.alt}
