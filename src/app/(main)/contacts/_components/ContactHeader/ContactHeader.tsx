  ...
  return (
    <div className="grid lg:grid-cols-5 gap-6">
      <div className="col-span-3">
        <p className="text-[17px] text-primary font-marcellus">
          24/7 Online Support
        </p>
      ...
      <p className="col-span-2 text-[#8E919F] text-[17px] border-s-2 ps-4 lg:ps-8 border-primary flex items-center">
