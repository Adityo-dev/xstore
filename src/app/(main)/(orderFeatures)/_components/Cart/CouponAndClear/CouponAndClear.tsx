interface CouponAndClearProps {
  onClearAllItems: () => void;
}

function CouponAndClear({ onClearAllItems }: CouponAndClearProps) {
  return (
    <div className="flex flex-col md:flex-row justify-between items-center gap-4 mt-8">
      <div className="flex w-full md:w-auto">
        ...
        />
        <button className="bg-[#776BF8] px-5 rounded-r-md font-semibold cursor-pointer">
          OK
        </button>
      </div>
      <button
