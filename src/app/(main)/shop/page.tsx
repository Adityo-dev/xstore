...
import CheckboxFilter from "./_components/SidebarFilters/CheckboxFilter";
  ...
  useEffect(() => {
    ...
    let filtered = [...products].filter((product) => {
      ...
      const ratingOK =
        ...
        ratingFilter.some((r) => {
          const avg =
            product.reviews?.reduce((sum: number, rev: any) => sum + rev.rating, 0) /
    ...
    if (sortBy === "popularity") filtered.sort((a, b) => b.sold - a.sold);
      ...
      filtered.sort(
        (a, b) =>
          ...
          (a.reviews?.reduce((sum: number, r: any) => sum + r.rating, 0) /
                ...
                (num) => (
                  <button
                    ...
                    className={`px-4 py-2 cursor-pointer ${
                      currentPage === num ? "bg-primary" : "bg-gray-700"
                    } text-white`}
                  >
                    {num}
                  </button>
