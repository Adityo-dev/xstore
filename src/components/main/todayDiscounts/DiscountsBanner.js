  ...
  return (
    <div className="col-span-full md:col-span-4 xl:col-span-3 rounded-lg overflow-hidden relative">
      <div className="sm:max-w-sm bg-[#1c1f26] rounded-xl overflow-hidden shadow-[0_0_10px_rgba(0,0,0,0.6)] border border-[#2a2d36] text-white">
        {/* Image */}
        <Link href={""} className="block sm:h-[160px] overflow-hidden relative">
          <Image
        ...
        <div className="p-4 space-y-2">
          <h3 className="text-[15px] font-semibold leading-snug">
            Towers And Titans Heroic Tower Defense With NFTs Real-Time Strategic
          </h3>
          ...
          <div className="flex items-center gap-2">
            <span className="text-gray-400 line-through text-sm">$99.33</span>
            <span className="text-[#37a937] text-[18px] font-bold">$59.64</span>
          </div>
