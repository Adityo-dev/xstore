...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 px-8 py-2.5 rounded-sm text-[17px] font-semibold border transition duration-300 cursor-pointer select-none disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
