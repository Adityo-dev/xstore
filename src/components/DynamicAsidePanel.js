...
export default function DynamicAsidePanel() {
  ...
  return (
    <>
      ...
      {/* Aside Panel */}
      <div
        className={`fixed top-0 w-[85vw] sm:w-[400px] h-[100vh] bg-[#1e1e1e] z-[1000] shadow-2xl flex flex-col ${position === "right"
      ...
      >
        ...
        <button
          onClick={closeAside}
          className={`absolute ${position === "right" ? "-left-12" : "-right-12"
